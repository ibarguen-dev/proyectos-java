...
public class CRUDNotaCurso 
{
    ...
    {   
       ...
       String codCurso= leerCadena("Ingresar Codigo del curso : ");
        ...
        if(BuscarCurso(objArchivo,codCurso) == false) 
         {
           ...
           codCurso= leerCadena("Ingresar Codigo del curso: ");
         }
        ...
        if(BuscarCurso(objArchivo,carneEstudiante) == false) 
         {
           ...
           codCurso= leerCadena("Ingresar carne del estudiante: ");
         }
       }while(BuscarCurso(objArchivo,carneEstudiante) == false);
       
        objNC = objNC.ingresarDatos(carneEstudiante, carneDocente,codCurso);//lee toda la informacion y recibe el objeto
    ...
    switch(op)
      {
        ...
        case 2:
          ...
          break;  
         case 3:
          String codCurso = leerCadena("ingrese el codigo del curso que desea consultar: ");
          for (NotaCurso nc : vecNC) 
          {
...
public String aprobadosXdocente(Archivo nc)
{
 ...
 /* Crear un Método que me permita hallar el promedio de notas de un estudiante */

...
public class Archivo 
{
   ...
   public String escribir(String registro)//graba el texto se dice que lo imprime en el archivo
    ...
    {
        int cl = contadorLineas("DatosEstudiantes.txt");
        Estudiante vecE[];
           ...
           int i = 0;
            while(cl>0)
            {
              ...
              vec = registro.split(separador);
               String carneEstudiante = vec[0];
               String nombre = vec[1];
               String apellido = vec[2];
               String tel = vec[3];
               String correo = vec[4];
               int edad = Integer.parseInt(vec[5]);
               Estudiante objE = new Estudiante (carneEstudiante,nombre,apellido, tel,correo,edad);
               vecE[i] = objE;
               i++;
               cl--;  
            }
           ...
           int i = 0;
            while(cl>0)
            {
              ...
              vec = registro.split(separador);
               ...
               int edad = Integer.parseInt(vec[5]);
               String titulo = vec[6];
               double salario = Double.parseDouble(vec[7]);
               Docente objD = new Docente (carneDocente,nombre,apellido, tel,correo,edad,titulo, salario);
               vecD[i] = objD;
               i++;
               cl--;  
            }
           ...
           int i = 0;
            while(cl>0)
            {
              ...
              vec = registro.split(separador);
               ...
               Curso objC = new Curso(codCurso,nombre,creditos);
               vecC[i] = objC;
               i++;
               cl--;  
            }
           ...
           int i = 0;
            while(cl>0)
            {
              ...
              vec = registro.split(separador);
               ...
               String estado = vec[3];
               double notaFinal = Double.parseDouble(vec[4]);

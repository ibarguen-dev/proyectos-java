...
public class CRUDCurso 
{
  ...
  public Curso Consultar(Archivo objArchivo, String codCurso) 
  {
  ...
  public void Actualizar(Archivo objArchivos, String cod)
   {
          ...
          do
           {
            ...
            switch(op)
             {
              case 1:
               creditos = leerCreditos("Ingrese la nueva edad del Curso: ");
               break;
              case 2:
               nombre = leerCadena("Ingrese el nuevo correo del Curso: ");
               break;
  ...
  public String EliminarRegistro(Archivo objArchivos, String cod) 
  {
        try 
        {
